...
const Header = () => {
    ...
    return (
        <header className='p-4 flex justify-center items-center'>
            <Link href={'/'} className='w-full justify-left flex gap-2 items-center'>
                <Image src={Logo} alt='Nexus Logo' />
                <span className='font-semibold dark:text-white'>nexus.</span>
            </Link>
            <NavigationMenu className='hidden md:block'>
                <NavigationMenuList className='gap-6'>
                        ...
                        <NavigationMenuContent>
                            <ul className='grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]'>
                                <li className='row-span-3'>
                                    <span className='flex g-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md'>
                                        welcome
                                    </span>
                                </li>
                        ...
                        <NavigationMenuContent>
                            <ul className='grid w-[400px] gap-3 p-4 md:grid-flow-2'>
                                ...
                                <ListItem href='#' title='Free Plan'>
                                    Great for teams just staring out
                                </ListItem>
                            </ul>
                        </NavigationMenuContent>
                    </NavigationMenuItem>
                    <NavigationMenuItem>
                        <NavigationMenuContent>
                            <ul className='grid w-[400px] gpa-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]'>
                                {
